...
{
    [DbContext(typeof(MomokoBlogDbContext))]
    [Migration("20240725015107_Post")]
    partial class Post
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Classifications.Classification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Posts.PostTag", b =>
                {
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Posts.Post", b =>
                {
                    b.HasOne("csumathboy.MomokoBlog.Classifications.Classification", null)
                        .WithMany()
            ...
            modelBuilder.Entity("csumathboy.MomokoBlog.Posts.PostTag", b =>
                {
                    b.HasOne("csumathboy.MomokoBlog.Posts.Post", null)
                        .WithMany("PostTags")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("csumathboy.MomokoBlog.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
